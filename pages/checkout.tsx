...
function Checkout() {
    ...
    // [key: string]: Product[]が何をしているかは下の記事を見よう↓
    //https://zenn.dev/eitches/articles/2020-0125-array-object-types

    //ちなみにオブジェクトの中に複数[key: string]: Product[]のセットがある場合は、配列の時のように{[key: string]: Product[]}なんて書き方はしなくてよい。単数の場合も複数の場合も書き方は同じで、[key: string]: Product[]。

    useEffect(() => {
        const groupItems = items.reduce((results, item) => {
            //下の代入は初期化しているんだよ！そうしないとエラー。
